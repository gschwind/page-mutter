...
gboolean          meta_window_is_tiled_with_custom_position (MetaWindow *window);
...
void        meta_window_make_tiled_with_custom_position         (MetaWindow  *window);
void        meta_window_unmake_tiled_with_custom_position         (MetaWindow  *window);
